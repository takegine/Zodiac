...
LinkLuaModifier( "modifier_axe_ult", "modifiers/hero_modi_axe_ult", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_axe_ult_timer", "modifiers/hero_modi_axe_ult", LUA_MODIFIER_MOTION_NONE )
