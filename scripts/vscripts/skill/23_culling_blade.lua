...
function CullingBlade( keys )
	...
	-- Ability variables
	local kill_threshold = ability:GetLevelSpecialValueFor("kill_threshold", ability_level) * _G.hardmode
	local damage = ability:GetLevelSpecialValueFor("damage", ability_level) * _G.hardmode
