function Spawn( entityKeyValues )
	...
	spiritsAbility = thisEntity:GetAbilityByIndex(0)--thisEntity:FindAbilityByName( "phoenix_fire_spirits_datadriven" )
	launchAbility  = thisEntity:GetAbilityByIndex(1)--thisEntity:FindAbilityByName( "phoenix_launch_fire_spirit_datadriven" )
	rayAbility     = thisEntity:GetAbilityByIndex(2)--thisEntity:thisEntity:FindAbilityByName( "phoenix_sun_ray_datadriven" )
	novaAbility    = thisEntity:GetAbilityByIndex(3)--thisEntity:FindAbilityByName( "phoenix_supernova_datadriven" )
